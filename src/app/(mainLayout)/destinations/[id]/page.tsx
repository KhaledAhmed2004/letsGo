    ...
    relatedDestinations: [
      {
        ...
        link: "/destinations/tropical-island",
    ...
    <section className="dark:bg-gray-800">
      <div className="destination-details bg-white text-gray-800 dark:bg-gray-900 dark:text-white shadow-lg rounded-lg overflow-hidden mx-auto max-w-7xl">
        ...
        <div className="description p-8 sm:p-10 lg:p-12">
          ...
          {/* Weather Information */}
          <div className="weather-info my-4 p-4 bg-blue-100 dark:bg-blue-800 rounded-lg">
        ...
        <div className="visitable-places p-8 sm:p-10 lg:p-12 bg-gray-50 dark:bg-gray-800">
          <h2 className="text-3xl font-semibold mb-6">Visitable Places</h2>
          <div className="grid grid-cols-1 sm:grid-cols-1 gap-8">
            {destination.visitablePlaces.map((place, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row mb-6 p-4 rounded shadow hover:shadow-lg transition-shadow duration-300 bg-white dark:bg-gray-700"
              >
                <Image
                  src={place.image.src}
                  alt={place.name}
        ...
        {/* Reviews Section */}
        <div className="reviews p-8 sm:p-10 lg:p-12 bg-gray-50 dark:bg-gray-800">
          <h2 className="text-3xl font-semibold mb-6">Reviews</h2>
          {destination.reviews.map((review, index) => (
            <div
              key={index}
              className="mb-4 p-4 border-b border-gray-300 dark:border-gray-600"
            >
        ...
        <div className="related-destinations p-8 sm:p-10 lg:p-12 bg-gray-50 dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {destination.relatedDestinations.map((dest, index) => (
              <div
                key={index}
                className="flex flex-col items-center bg-gray-100 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800"
              >
                <Image
                  src={dest.image}
                  alt={dest.name}
