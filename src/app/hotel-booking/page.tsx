...
//       <h1 className="text-4xl font-bold text-center my-8">Our Rooms</h1>
//       {/* Main Flex Container */}
...
//               <div
//                 key={room.id}
//                 className="max-w-sm rounded-lg overflow-hidden shadow-lg bg-white transition-transform transform hover:scale-105 hover:shadow-xl"
//               >
//                 <img
...
const App = () => {
  ...
  return (
    <div className="container mx-auto p-4 dark:bg-gray-800">
      <h1 className="text-4xl font-bold text-center my-8 text-gray-900 dark:text-white">Our Rooms</h1>
      {/* Main Flex Container */}
      <div className="flex flex-wrap">
        {/* Filter Section */}
        <div className="w-full md:w-1/4 p-4">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Filter Rooms</h2>
          <div className="mb-4">
            <label className="block mb-2 text-gray-700 dark:text-gray-300">Min Price:</label>
            <input
              type="number"
              name="minPrice"
              value={filters.minPrice}
          ...
          <div className="mb-4">
            <label className="block mb-2 text-gray-700 dark:text-gray-300">Max Price:</label>
            <input
              type="number"
              name="maxPrice"
              value={filters.maxPrice}
          ...
          <div className="mb-4">
            <label className="block mb-2 text-gray-700 dark:text-gray-300">Room Type:</label>
            <select
              name="roomType"
              value={filters.roomType}
              onChange={handleFilterChange}
            ...
            {filteredRooms.map((room) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-base mb-4 dark:text-gray-300">
                    {room.description}
                  </p>
                  <p className="text-gray-800 font-bold text-lg dark:text-gray-200">
                    ${room.price} / night
                  </p>
                  <div className="mt-4">
                    <button className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition duration-200 ease-in-out">
