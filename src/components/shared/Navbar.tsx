...
// import Cookies from "js-cookie"; // Install js-cookie if you haven't
...
//     const accessToken = Cookies.get("accessToken"); // Use js-cookie to fetch the token
...
//   console.log("Client-side role:", role);
